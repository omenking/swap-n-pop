module.exports = function(game){
  const blank = require('./panel_blank')(game)
  const {
    UNIT,
    SWAP_L,
    SWAP_R,
  ...
  const ComponentBaubleChain  = require('./bauble')(game)
  const ComponentPanelGarbage = require('./panel_garbage')(game)
  const ComponentPanelParticle = require('./panel_particle')(game)
