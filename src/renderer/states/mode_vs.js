module.exports = function(game){
  ...
  const ComponentPing        = require('../components/ping')(game)
  const ComponentDebugFrame  = require('../components/debug_frame')(game)
  const ComponentTimer       = require('../components/timer')
  const ComponentMenuPause   = require('../components/menu_pause')(game)
  const ComponentStarCounter = require('../components/star_counter')(game)

  const CoreInputs         = require('../core/inputs')(game)
  const CoreSnapshots      = require('../core/snapshots')(game)
